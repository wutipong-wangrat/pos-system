...
<body class="font-noto_thai ">
    <header class="relative flex pt-32 pb-48 sm:pt-32 sm:pb-64 lg:pb-48 px-4 bg-blue-100 w-full md:pb-40 lg:px-16 lg:pt-48 xl:pt-40 xl:pb-64 xl:h-screen md:px-8 xl:px-24 xxl:px-40">
        <div class="text-center md:text-left md:w-1/2 z-10 xxl:max-w-2xl">
          <h1 class="text-3xl xl:text-5xl text-gray-900 font-bold leading-tight fade-in">
            <span class="text-cyan-500 text-shadow-2xl">Pos_System</span> ยินดีต้อนรับ 
          </h1>
          <p class="text-base xl:text-xl text-gray-600 mt-4 fade-in-delay-1">
            โปรเจกต์นี้จัดทำขึ้นเพื่อใช้เป็นส่วนหนึ่งของการศึกษาในหลักสูตรวิชาชีพ และเป็นส่วนหนึ่งของการส่งเสริมการเรียนรู้การพัฒนาระบบ <span class="font-bold underline text-cyan-500">POS</span>
            ในด้าน <strong>Backend</strong> เพื่อแสดงความสามารถในการออกแบบและพัฒนาโปรแกรมสำหรับการจบการศึกษา 
          </p>
    
          <p class="text-sm xl:text-base text-gray-600 mt-8 fade-in-delay-2">
